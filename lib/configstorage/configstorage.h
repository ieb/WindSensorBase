...
extern int32_t nvs_open(const char * storage_namespace, int flags, nvs_handle_t *my_handle);
extern int32_t nvs_set_blob(nvs_handle_t my_handle, const char *key, void * data, size_t len);
extern int32_t nvs_commit(nvs_handle_t my_handle);
extern int32_t nvs_close(nvs_handle_t my_handle);
extern int32_t nvs_get_blob(nvs_handle_t my_handle, const char *key, void * data, size_t * len);
